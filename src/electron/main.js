...
ipcMain.handle("launcher:setAutoLoginProfileSelection", async (_event, options) => backend.setAutoLoginProfileSelection(options || {}));
ipcMain.handle("launcher:reorderAutoLoginProfiles", async (_event, options) => backend.reorderAutoLoginProfiles(options || {}));
